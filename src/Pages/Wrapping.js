                    ...
                    <tr className='w-full items-center'>
                      ...
                      {InventoryData.map((val, key) => {
                        ...
                        const reduceQuantity = (event) => {
                          ...
                          return (
                            <>
                                  {val.Category === "WRAPPING SERVICES".toUpperCase() ? 
                                  <tr className='items-center w-full' key={key}>
                                  ...
                                  <td className='text-center w-1/4 py-2'><button onClick={getPrices} className=''>ADD</button></td>
                                  </tr>
                                  :
                                    <>
                                    </>
